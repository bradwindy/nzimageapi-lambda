...
**Wellington removal: done.** Collections **1–45 terminal** (Howick 17 RE-DONE; TAPUHI 25 committed via a
...
**1.56–2.25×** (median 2.25×) improvement, **100% available, 0 null-image, no honest-smaller fork**). The
per-collection sweep is **UNPAUSED — next is order 46 (Ngā Puhipuhi o Te Herenga Waka—Victoria University of
Wellington Art Collection).**
