...
**Wellington removal: done.** Collections **1–42 terminal** (Howick 17 RE-DONE; TAPUHI 25 committed via a
...
**63/64 pixel-win, median 11.7×, up to 144× / 24 MP**, 0 stale/dead). The per-collection sweep is **UNPAUSED
— next is order 43 (Victoria and Albert Museum).**
