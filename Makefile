# SAM custom-runtime build target for the Swift Lambda (provided.al2023).
...
# static arm64 Amazon Linux 2023 binary in Docker (pinned --platform linux/arm64 to match
